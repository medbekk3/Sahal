...
export default function LoginPage() {
  ...
  return (
    <div dir="rtl" className="flex min-h-screen items-center justify-center bg-[radial-gradient(circle_at_top_left,_#2563eb,_transparent_35%),linear-gradient(135deg,_#111827,_#1e3a8a_50%,_#111827)] p-4">
      <motion.div
      ...
      >
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-sm text-blue-100">ادخل إلى لوحة التحكم الخاصة بساهل.</p>
        </div>
